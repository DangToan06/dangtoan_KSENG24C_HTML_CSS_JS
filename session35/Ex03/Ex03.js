...
function searchProducts() {
    ...
    if (filteredProducts.length === 0) {
        ...
        productContainer.innerHTML = `<p class="text-center text-danger">Không tìm thấy sản phẩm nào!</p>`;
    }
}
    ...
    products.forEach(product => {
        const productCard = `
            <div class="product-card">
                ...
                <p class="product-price">${parseInt(product.price).toLocaleString()} VNĐ</p>
